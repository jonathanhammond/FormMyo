...
- (void)didReceiveOrientationEvent:(NSNotification *)notification {
    ...
    _pitch.radiansValue = angles.pitch.radians;
    _yaw.radiansValue = angles.yaw.radians;
    _roll.radiansValue = angles.roll.radians;
...
- (void)didReceiveAccelerometerEvent:(NSNotification *)notification {
   ...
   // self.accelerationProgressBar.progress = magnitude / 8;
    ...
    _xAcceleration.numberValue = accelerationVector.x;
    _yAcceleration.numberValue = accelerationVector.y;
    _zAcceleration.numberValue = accelerationVector.z;
    ...
    switch (pose.type) {
        ...
        case TLMPoseTypeFingersSpread:
           ...
           // self.helloLabel.text = @"Fingers Spread";
            _pose.stringValue = @"Fingers Spread";
